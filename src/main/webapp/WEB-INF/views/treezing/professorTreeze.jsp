...
<head>
	...
	<script type="text/javascript">
		...
		function on_load(){
			...
			$.get( "http://113.198.84.80:8080/treeze/ajax/mainpage", function( data ) {
				treezingHtml[0] = data;
...
<body onkeydown="on_keycode()" onload="on_load()">
			...
			<div class="row">
				...
				<div class="span12">
					<div class="row">
						...
						<a class="btn btn-info pull-right" style="margin-left:10px" href="addMypage.html">수강 신청</a>
		...
		<div class="row">
			<div class="span12">
				<div class="title-page">
					...
					<center>
						<div class="page-description" style="border-radius: 6px;background-color: #E9C79B;">
