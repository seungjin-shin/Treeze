...
public class MindmapController {
	private static final Logger logger = LoggerFactory
			.getLogger(MindmapController.class);
	@Autowired
	...
	@RequestMapping(value = "/isRegistedMindmap", method = RequestMethod.GET)
	public String isRegistedMindmap(@RequestParam("classId") Long classId,
			ModelMap map) {
		boolean isRegistedMindmap = mindmapService.exists(classId);
		
		if(isRegistedMindmap){
			return "true";
		}
