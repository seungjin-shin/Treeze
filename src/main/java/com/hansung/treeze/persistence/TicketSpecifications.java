...
public class TicketSpecifications {
	...
	public static Specification<Ticket> isTicketsOnUserEmail(final Long classId, final String userEmail){
		return new Specification<Ticket>() {
			...
			public Predicate toPredicate(Root<Ticket> root,
					CriteriaQuery<?> query, CriteriaBuilder cb) {
				// TODO Auto-generated method stub
				return cb.and(cb.equal(root.<Long>get(Ticket_.classId), classId),cb.equal(root.<String>get(Ticket_.userEmail), userEmail));
			}
		};
	}
