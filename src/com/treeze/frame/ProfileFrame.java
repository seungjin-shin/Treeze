...
public class ProfileFrame extends JFrame {
	...
	PersonalInfo personalInfo = new PersonalInfo("ÇÑ¼º´ëÇÐ±³ ÄÄ°ø", "ÇÐ»ý", "°æ±âµµ ÆòÅÃ");
	...
	public ProfileFrame() {
		...
		insets.top = 0;
		insets.bottom = 0;
		JLabel noPanel = new JLabel("°ú ¸ñ ¸í", JLabel.CENTER);
		JLabel subjectPanel = new JLabel("±³ ¼ö ¸í", JLabel.CENTER);
		JLabel whritePane = new JLabel("»ó  ÅÂ", JLabel.CENTER);
		lectureHead.setLayout(gbl);
		addGrid(gbl, gbc, noPanel, 0, 0, 1, 1, 12, 1, lectureHead);
