...
public class EditAction extends AbstractAction implements ActorXml {
    ...
    public void edit(
    	...
    	System.out.println(mMindMapController.getSelected().getText());
...
//        
    ...
    public void setNodeText(MindMapNode selected, String newText){
        ...
        mMindMapController.getActionFactory().startTransaction(mMindMapController.getText("edit_node"));
        ...
        mMindMapController.getActionFactory().executeAction(new ActionPair(EditAction, undoEditAction));
        mMindMapController.getActionFactory().endTransaction(mMindMapController.getText("edit_node"));
